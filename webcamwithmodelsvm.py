...
model = joblib.load("joblib SVM/final_emotion_detection_svm_model.joblib")
label_encoder = joblib.load("joblib SVM/label_encoder.joblib")
pca = joblib.load("joblib SVM/pca.joblib")
